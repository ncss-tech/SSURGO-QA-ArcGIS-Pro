        ...
        for subFolder in surveyList:
	       ...
	       # folder is named with just FIPS i.e. WI001
            ...
            if bSTATSGO:
                ...
                soilShpPath = os.path.join(os.path.join(sdmLibrary, SSA), SSA + "_a.shp")
                soilSaShpPath = soilShpPath
            ...
            if not bSTATSGO:
                ...
                muLineShpPath = os.path.join(os.path.join(sdmLibrary, SSA), SSA + "_c.shp")
                muPointShpPath = os.path.join(os.path.join(sdmLibrary, SSA), SSA + "_d.shp")
                soilSaShpPath = os.path.join(os.path.join(sdmLibrary, SSA), SSA + "_b.shp")
                featPointShpPath = os.path.join(os.path.join(sdmLibrary, SSA), SSA + "_p.shp")
                featLineShpPath = os.path.join(os.path.join(sdmLibrary, SSA), SSA + "_l.shp")
